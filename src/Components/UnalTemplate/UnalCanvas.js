...
export default withRouter(function Canvas(props) {
  return (
    <div>
      <meta charSet="utf-8" />
      ...
      <div id="footfix">
        ...
        <header id="unalTop">
          ...
          <div id="bs-navbar" className="navbar-collapse collapse navigation">
            <div className="site-url">
              <a href="https://www.ingenieria.bogota.unal.edu.co/ingreso_laboratorios/">
                ingenieria.bogota.unal.edu.co/ingreso_laboratorios/
              </a>
            </div>
        ...
        <main
          className="detalle"
          style={{ marginLeft: "50px", marginRight: "50px", paddingTop: "2%" }}
        >
          {props.children}
        </main>
      </div>
